              ...
              <Navbar.Collapse id="responsive-navbar-nav">
                <Nav className="mr-auto">
                  ...
                  <NavDropdown title="" id="collasible-nav-dropdown">
                    <NavDropdown.Item href="http://localhost:3000/weather">Thời tiết</NavDropdown.Item>
                ...
                <Nav>
                  <Clock style={{float:'right', marginRight:'34px', fontSize:'28px', color:'white'}} format={'HH:mm:ss'} ticking={true} timezone={'Asia/Ho_Chi_Minh'} />
          ...
          <div>
            ...
            <Navbar.Collapse id="responsive-navbar-nav">
              <Nav className="mr-auto">
                ...
                <NavDropdown title="" id="collasible-nav-dropdown">
                  <NavDropdown.Item href="http://localhost:3000/weather">Thời tiết</NavDropdown.Item>
                  <NavDropdown.Item href="http://localhost:3000/manager">Quản lý các tour</NavDropdown.Item>
                  <NavDropdown.Item href="http://localhost:3000/order">Quản lý danh sách các order</NavDropdown.Item>
                  <NavDropdown.Divider />
                  <NavDropdown.Item href="#action/3.4">Separated link</NavDropdown.Item>
                </NavDropdown>
