...
describe('SignUp', () => {
  it('click button signup', () => {
    ...
    wrapper1.find('#emailSignUp').simulate('change', {target: {
      value: 'arsenal'
    }})
    wrapper1.find('#usernameSignUp').simulate('change', {target: {
      value: 'chelsea'
    }})
    wrapper1.find('#signup-btn').at(0).simulate('click')
    wrapper1.find('#signup-btn').at(1).simulate('click')
